...
const fakeUrl = 'https://mdn.github.io/learning-area/javascript/oojs/json/superheroes.json'
const URL = 'https://github.com/rolling-scopes-school/tasks/blob/master/tasks/markups/level-2/shelter/pets.json'
petsList = [{
    "name": "Jennifer",
...
class Pet {
    ...
    render(){
        return `<div class="pet-card" data-id="${this.name}">  
        <div class="pet-card__img">
            <img src="${this.img}" alt="cat ${this.name}">
       </div>
       <div class="pet-card__text">
           <span>${this.name}</span>
           <a href="#" data-info="true" data-name="${this.name}">Learn more</a>
       </div>
       </div>`
    }
